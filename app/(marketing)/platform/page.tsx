...
const MODULES = [
  ...
  { num: "07", icon: Briefcase,   eyebrow: "ADOPTION CONSTELLATION",title:"Business Productivity AI",tone: "lens"   as const, body: "Microsoft 365 Copilot — licensed seats, per-user adoption across Teams, Word, Excel & Outlook, and dormant-seat detection from each user's last-activity date." },
