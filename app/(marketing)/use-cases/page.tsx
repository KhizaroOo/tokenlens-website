...
const SIGNALS = [
  ...
  { type: "ADOPTION"    as const, icon: Briefcase,  title: "Business Productivity AI",    problem: "Bought 500 M365 Copilot licenses — no idea if business users actually use them.",     solution: "Per-user adoption (Teams, Word, Excel, Outlook) with dormant-seat flags from last-activity dates.", outcome: "IT reclaims unused seats before next renewal, with per-user activity to back it up." },
